        ...
        display: [
            {
                ...
                fired_msg: "Answered within 5 seconds, so the activated player earns an additional 5 coins!",
            },
            {
                lang: "Japanese",
                name: "ファイブースト",
                comment: "5秒以内に解答できたら追加で5コイン獲得できる。[パッシブアビリティ]",
                fired_msg: "5秒以内に解答したので、発動したプレイヤーは追加で5コイン獲得！",
            },
            {
                lang: "Chinese",
                name: "五促进",
                comment: "如果您能在5秒内回答, 您可以额外获得5个硬币。[被动技能]",
                fired_msg: "5秒内回复、激活玩家额外获得5个金币！",
            },
        ],
    },
]
        ...
        display: [
            {
                ...
                fired_msg: "Since the number of cards used for the answer was the largest, the activated player randomly reduced 2 cards other than himself!",
            },
            {
                lang: "Japanese",
                name: "数の暴力",
                comment: "解答に使用したカード枚数が全員の中で最も多ければ、相手全員のカードをランダムに2枚減らす。[パッシブアビリティ]",
                fired_msg: "解答に使用したカード枚数が最も多かったので、発動したプレイヤー以外のカードをランダムに2枚減らした！",
            },
            {
                lang: "Chinese",
                name: "数字的暴政",
                comment: "如果用于答案的牌数是所有牌中最多的, 则所有对手的牌随机减2。[被动技能]",
                fired_msg: "因为答题用的牌数最多、所以我随机把激活玩家以外的牌数减少了两张！",
            },
        ],
    },
]
