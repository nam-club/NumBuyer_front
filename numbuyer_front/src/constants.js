        ...
        display: [
            {
                lang: "English",
                name: "Catastrophe",
                comment: "Reduce everyone's coins by 0-30 coins (can be used twice).[Active Ability]",
                fired_msg: ["Everyone's coins have been reduced by 0-30 coins!"],
            },
            {
                lang: "Japanese",
                name: "カタストロフィ",
                comment: "全員のコインを０〜３０コイン減らす(２回使用可能)。[アクティブアビリティ]",
                fired_msg: ["全員のコインが０〜３０コイン減らされた！"],
            },
            {
                lang: "Chinese",
                name: "灾难",
                comment: "减少每个人的硬币０ー３０个硬币（可以使用两次）。[主动技能]",
