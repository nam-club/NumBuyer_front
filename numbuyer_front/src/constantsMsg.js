export const English = {
    ...
    BEFORE_GAME_MSG15: "①Click here to leave the room and return to the title.",
    BEFORE_GAME_MSG16: "②Click here to copy the room code for this room. (Tell your friends who want to join this room code)",
    BEFORE_GAME_MSG17: "③Once the room has 2-4 participants, the room owner can click here to start the game.",
...
export const Japanese = {
    ...
    BEFORE_GAME_MSG15: "①ここをクリックするとルームを退場してタイトル画面に戻ることができます。",
    BEFORE_GAME_MSG16: "②ここをクリックすると、このルームのルームコードをコピーできます。（このルームコードを参加させたい友達に教えてください）",
    BEFORE_GAME_MSG17: "③ルームの参加者が２〜４人になると、ルームの作成者はここをクリックしてゲームを開始できます。",
...
export const Chinese = {
    ...
    BEFORE_GAME_MSG5: "④如果您单击“与朋友对战“，您可以通过共享房间代码与熟人一起玩２-４名。",
    ...
    BEFORE_GAME_MSG15: "①单击此处离开房间并返回标题屏幕。",
    BEFORE_GAME_MSG16: "②单击此处复制此房间的房间代码。（告诉你想加入这个房间代码的朋友）",
    BEFORE_GAME_MSG17: "③一旦房间有２-４名参与者，房间创建者可以单击此处开始游戏。",
