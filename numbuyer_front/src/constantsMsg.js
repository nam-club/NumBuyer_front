export const English = {
    ...
    CPU_MATCH: 'Single Play',
    LANG: "Language",
    LANG_EN: "English",
    LANG_JP: "日本語（Japanese）",
    LANG_CN: "中文（Chinese）",
    TOTAL_ROOM_COUNT: "number of rooms currently in existence",
    AVAILABLE_QM_COUNT: "Number of Quick Match currently available",
    TUTORIAL: "Tutorial",
    ...
    BEFORE_GAME_MSG6: '⑤If you press "Single Play", you can play against the computer with 4 players.',
    BEFORE_GAME_MSG7: "Select abilities",
    BEFORE_GAME_MSG8: "①Select the two abilities you want to use from the five types of abilities.",
    BEFORE_GAME_MSG9: '②After selecting an ability, press "Done" to proceed to the next screen.',
    BEFORE_GAME_MSG10: 'Create or enter a room (in the case of "Play with Friends")',
    BEFORE_GAME_MSG11: "①Create a new room to play the game.",
    BEFORE_GAME_MSG12: "②Ask the room owner to tell you the room code and enter it.",
    BEFORE_GAME_MSG13: "③Enter the room with the room code you entered.",
    BEFORE_GAME_MSG14: 'Lobby (in the case of "Play with Friends")',
    BEFORE_GAME_MSG15: "The participants in the room are displayed. (There is an icon next to the room owner)",
    BEFORE_GAME_MSG16: "①You can press here to leave the room and return to the title screen.",
    BEFORE_GAME_MSG17: "②Press here to copy the room code for this room. (Tell your friends who want to join this room code)",
    BEFORE_GAME_MSG18: "③When the room has 2-4 participants, the room creator can press here to start the game.",
    BEFORE_GAME_MSG19: 'Lobby (in the case of "Quick Match")',
    BEFORE_GAME_MSG20: "The participants in the room are displayed. ",
    BEFORE_GAME_MSG21: "The game starts when there are 4 participants in the room.",
    DISTRIBUTION_MSG1: "Start the game",
    DISTRIBUTION_MSG1_1: "①The current turn number is displayed here.",
    ...
    USE_ABILITIES_MSG2_MOBILE: "①You can check your own abilities in the player information on the right side, and tap the ability to see the effect.",
    ...
    USE_ABILITIES_MSG5_MOBILE: "Tap the i icon to see the effect of the ability. Press the button to activate the ability.",
...
export const Japanese = {
    ...
    LANG_JP: '日本語',
    LANG_CN: '中文（中国語）',
    TOTAL_ROOM_COUNT: "現在存在している部屋の数",
    AVAILABLE_QM_COUNT: "「誰かと対戦する」の参加可能な部屋の数",
    TUTORIAL: 'チュートリアル',
    ...
    BEFORE_GAME_MSG6: "⑤「一人で遊ぶ」を押すと、コンピュータと4人対戦できます。",
    BEFORE_GAME_MSG7: "アビリティを選択する",
    BEFORE_GAME_MSG8: "①５つのタイプのアビリティから使用したいアビリティを２つ選択します。",
    BEFORE_GAME_MSG9: "②アビリティを選択したら「確定」を押すと次の画面に進みます。",
    BEFORE_GAME_MSG10: "ルームを作成または入室する（「友達と対戦する」の場合）",
    BEFORE_GAME_MSG11: "①新たにゲームをプレイするルームを作ります。",
    BEFORE_GAME_MSG12: "②ルームの作成者からルームコードを教えてもらい、ルームコードを入力してください。",
    BEFORE_GAME_MSG13: "③入力したルームコードのルームに入室します。",
    BEFORE_GAME_MSG14: "ロビー（「友達と対戦する」の場合）",
    BEFORE_GAME_MSG15: "ルームの参加者が表示されます。（ルームの作成者の横にはアイコンが付きます）",
    BEFORE_GAME_MSG16: "①ここを押すとルームを退場してタイトル画面に戻ることができます。",
    BEFORE_GAME_MSG17: "②ここを押すと、このルームのルームコードをコピーできます。（このルームコードを参加させたい友達に教えてください）",
    BEFORE_GAME_MSG18: "③ルームの参加者が２〜４人になると、ルームの作成者はここを押してゲームを開始できます。",
    BEFORE_GAME_MSG19: "ロビー（「誰かと対戦する」の場合）",
    BEFORE_GAME_MSG20: "ルームの参加者が表示されます。",
    BEFORE_GAME_MSG21: "ルームの参加者が４人になると、ゲームが開始されます。",
    DISTRIBUTION_MSG1: "ゲームの開始",
    DISTRIBUTION_MSG1_1: "①ここに現在のターン数が表示されます。",
    ...
    USE_ABILITIES_MSG2_MOBILE: "①自分の所持アビリティは右側のプレイヤー情報で確認でき、アビリティをタップすると効果が表示されます。",
    ...
    USE_ABILITIES_MSG5_MOBILE: "iアイコンをタップするとアビリティの効果が表示されます。ボタンを押すとアビリティを発動できます。",
...
export const Chinese = {
    ...
    LANG_JP: '日本語（日语）',
    LANG_CN: '中文',
    TOTAL_ROOM_COUNT: "目前存在的房间数量",
    AVAILABLE_QM_COUNT: "可用于“与某人对战”的房间数量",
    TUTORIAL: '教程',
    ...
    BEFORE_GAME_MSG6: "⑤如果按“单独玩”，您可以与4名玩家一起对战电脑。",
    BEFORE_GAME_MSG7: "选择一个能力",
    BEFORE_GAME_MSG8: "①从五种能力中选择您要使用的两种能力。",
    BEFORE_GAME_MSG9: "②选择能力后，按“确定”进入下一个屏幕。",
    BEFORE_GAME_MSG10: "创建或进入房间（在“与朋友对战“的情况下）",
    BEFORE_GAME_MSG11: "①创建一个新房间来玩游戏。",
    BEFORE_GAME_MSG12: "②请房间创建者告诉您房间代码并输入房间代码。",
    BEFORE_GAME_MSG13: "③使用您输入的房间代码进入房间。",
    BEFORE_GAME_MSG14: "大厅（在“与朋友对战”的情况下）",
    BEFORE_GAME_MSG15: "显示房间中的参与者。（房间创建者旁边有一个图标）",
    BEFORE_GAME_MSG16: "①您可以按此处离开房间并返回标题屏幕。",
    BEFORE_GAME_MSG17: "②按此处复制此房间的房间代码。（告诉你想加入这个房间代码的朋友）",
    BEFORE_GAME_MSG18: "③当房间有2-4名时，房间创建者可以按这里开始游戏。",
    BEFORE_GAME_MSG19: "大厅（在“与某人对战“的情况下）",
    BEFORE_GAME_MSG20: "显示房间中的参与者。",
    BEFORE_GAME_MSG21: "当房间里有４名参与者时，游戏开始。",
    DISTRIBUTION_MSG1: "开始游戏",
    DISTRIBUTION_MSG1_1: "①此处显示当前轮数。",
