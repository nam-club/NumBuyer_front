export const English = {
    ...
    CALC_FINISH_MSG3: ' coin(card number bonus : ',
    CALC_FINISH_MSG4: ' coin) will be given to the person giving correct answer!',
...
export const Japanese = {
    ...
    CALC_FINISH_MSG3: 'コイン(カード枚数ボーナス: +',
    CALC_FINISH_MSG4: 'コイン）が配られます!',
