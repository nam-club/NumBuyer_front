...
const Top = () => {
    ...
    const clickQuick = () => {
        if(selector.top.name !== '' && !selector.top.name.match(Constants.NAME_EXP)) {
            dispatch(setPlayerAction({id: "001", name: selector.top.name, money: Constants.MONEY, cards: ['4', '5'], own: true}));
            dispatch(setPlayerAction({id: "002", name: "aoki", money: Constants.MONEY, cards: [], own: false}));
            dispatch(setPlayerAction({id: "003", name: "maeda", money: Constants.MONEY, cards: [], own: false}));
            dispatch(setPlayerAction({id: "004", name: "nagasawa", money: Constants.MONEY, cards: [], own: false}));
